...
add_action('wp_enqueue_scripts', function () {
    ...
    wp_enqueue_style('sage/main.css', asset_path('styles/main.css?v=' . $microtime), false, null);
    wp_enqueue_style('sage/components.css', asset_path('styles/components.css?v=' . $microtime), false, null);
    // [ JS ]
//	wp_enqueue_script('sage/vue.js', 'https://cdnjs.cloudflare.com/ajax/libs/vue/2.4.1/vue.min.js');
    wp_enqueue_script('sage/vendor.js', asset_path('scripts/vendor.js'), ['jquery'], null, true);
    wp_enqueue_script('sage/main.js', asset_path('scripts/main.js?v=' . $microtime), ['jquery'], null, true);
    wp_enqueue_script('sage/components.js', asset_path('scripts/components.js?v=' . $microtime), ['jquery'], null, true);
}, 100);
...
add_action('after_setup_theme', function () {
    ...
    register_nav_menus([
        ...
        'primary_navigation_footer' => __('Primary Navigation Footer', 'sage')
    ]);
...
add_action('after_setup_theme', function () {
    ...
    sage('blade')->compiler()->directive('dist', function ($asset) {
        return "<?= App\\asset_path({$asset}); ?>";
    });
});
